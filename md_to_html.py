...
USAGE
    ...
    Defaults: input.md  = genai_learning_resources.md
              output.html = genai_learning_resources.html
...
<div class="wrap">
  ...
  <footer>
    Generated by md_to_html.py from genai_learning_resources.md — edit the Markdown, then re-run the script to refresh this page.
    {global_notes_html}
  </footer>
</div>
...
def main():
    in_path = sys.argv[1] if len(sys.argv) > 1 else "genai_learning_resources.md"
    out_path = sys.argv[2] if len(sys.argv) > 2 else "genai_learning_resources.html"
